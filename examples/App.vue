<template>
    <div id="app">
        <div class="_fc-t-header">
            <img class="_fc-t-logo" style="display: none" src="http://form-create.com/logo.png">
            <div class="_fc-t-name">表单设计器</div>
            <div class="_fc-t-menu" style="display: none">
        ...
        <ElFooter class="_fc-copyright" height="5px">
        </ElFooter>
